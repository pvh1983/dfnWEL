...
//unsigned int nnodes_in_azone;  //hpham added this for a number of nodes in a zone (read allboudaries.zone)
//int nnode_iwel;     //Number of nodes at the injection well zone. 
...
int main (int argc, char* controlf[]) {
  ...
  printf("\n---------------------BOUNDARY CONDITIONS----------------------\n"); 
  ReadBoundaryNodes();
  ReadBoundaryNodes_hpham(); printf("\n This runs ReadBoundaryNodes_hpham !!! \n");
