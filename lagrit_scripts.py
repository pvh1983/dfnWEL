...
#    os.system('cp -f $model_path/well_locations.dat .')
    lagrit_input = '''
...
#cmo/readatt/mo_name/ x,y,top,bot,rad / 1,0,0 / well_locations.dat


# Line: (1) Interpore, (2) ms6_hypo, (3) LFA


#[Well 1] Cells to pump water out.
surface/acyl1/free/cylinder/0.0,0.0,4.99/0.0,0.0,-4.99/0.10
region/r1/lt/acyl1
pset/well_1/region/r1
pset/well_1/zone/pointset_well1/ascii

 
#[Well 2]
surface/acyl2/free/cylinder/0.0,0.0,4.99/0.0,0.0,-4.99/0.10
region/r2/lt/acyl2
pset/well_2/region/r2
pset/well_2/zone/pointset_well2/ascii

 


#[Well 3]
surface/acyl3/free/cylinder/0.0,0.0,4.99/0.0,0.0,-4.99/0.10
region/r3/lt/acyl3
pset/well_3/region/r3
pset/well_3/zone/pointset_well3/ascii


#[Well 12] Cells to pump water out.
surface/acyl12/free/cylinder/0.0,0.0,5.01/0.0,0.0,-5.01/5.005
region/r12/lt/acyl12
pset/well_12/region/r12
pset/well_12/zone/pointset_well12/ascii

#[Well 22]
surface/acyl22/free/cylinder/0.0,0.0,5.01/0.0,0.0,-5.01/5.005
region/r22/lt/acyl22
pset/well_22/region/r22
pset/well_22/zone/pointset_well22/ascii


#[Well 32]
surface/acyl32/free/cylinder/0.0,0.0,5.01/0.0,0.0,-5.01/5.005
region/r32/lt/acyl32
pset/well_32/region/r32
pset/well_32/zone/pointset_well32/ascii
...
'''
    ...
    files=['bottom','left_w','front_s','right_e','back_n']
    for f in files:
            ...
            fzone.close() 
            fall.writelines(lines)    
    files=['well1','well2','well3','well12','well22']

    for f in files:
            fzone=open("pointset_%s.zone"%f,"rb")
            lines=fzone.readlines()
            lines=lines[1:-2]
            fzone.close() 
            fall.writelines(lines)

    fzone=open("pointset_well32.zone","rb")
    lines=fzone.readlines()
    lines=lines[1:]
    fzone.close() 
    fall.writelines(lines)
